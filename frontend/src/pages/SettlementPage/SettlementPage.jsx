...
function SettlementPage({ data }) {
  ...
  return (
    <>
  {usersData.ongoingMastery.currentBadge?.length > 0 && (
    <div style={{ height: '36px', flexShrink: 0 }} />
  )}

    <div className={styles['main-box']} style={(usersData.ongoingMastery.currentBadge && usersData.ongoingMastery.currentBadge.length > 0) ? { paddingTop: '36px' } : undefined}>
