...
public class ChatRoomInitRequest {
    ...
    @Size(max = 500, message = "시나리오 미션은 500자 이하여야 합니다.")
    private String scenarioGoal;

    @Size(max = 1000, message = "시나리오 상황묘사 설명은 1000자 이하여야 합니다.")
    private String scenarioSituation;
